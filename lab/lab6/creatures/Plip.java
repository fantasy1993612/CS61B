...
public class Plip extends Creature {
    ...
    /*stay gain energy*/
    private static final double gainEnergy = 0.2;
    /*max energy*/
    private static final double maxEnergy = 2.00;
    /*zero energy*/
    private static final double zeroEnergy = 0.00;
    ...
    public void stay() {
        ...
        double currEnergy = energy + gainEnergy;
    ...
    public Plip replicate() {
        double offspringEnergy = energy*0.5;
        energy = 0.5*energy;

        Plip pBaby = new Plip(offspringEnergy);
